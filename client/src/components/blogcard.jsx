...
export default function BlogCard({title,content,user}){
  ...
  return (
    <>
        <div>
           <div className="bg-blue-200 shadow-xl h-40 w-full mb-5 rounded-xl p-4 transition-transform duration-300 hover:scale-101 relative z-0">
         ...
         <div className="rounded-xl flex flex-row-reverse ">
          <Link to="/blog" className="h-auto mt-2 min-w-20 p-2 hover:bg-violet-400 ml-3 bg-gray-300 rounded-xl">Read More</Link>
